export const portfolioData = {
  designer: {
    ...
    experience: "10+ years",
    email: "aimansyahran16@gmail.com",
    phone: "+966 56-718-0671",
    social: {
      linkedin: "https://www.linkedin.com/in/aimansyahran",
      behance: "https://behance.net/aimansyahran",
      instagram: "https://www.instagram.com/aimansyahran/"
    }
  },

  hero: {
    headline: "I design visuals that move brands.",
    subtext: "Senior graphic designer leading high-impact, large-scale projects—merging elevated creative design, premium 3D, and AI to craft distinctive, future-ready visuals.",
    cta: {
      primary: "View Work",
  ...
  services: [
    {
      ...
      description: "Complete visual identity systems that capture essence and elevate presence.",
      icon: "brand"
    },
    {
      title: "Visual Design",
      description: "Compelling visuals that communicate with clarity and artistic precision.",
      icon: "visual"
    },
    {
      title: "UI/UX Design",
      description: "User-centered digital experiences that balance aesthetics with functionality.",
      icon: "uiux"
    },
    {
      title: "Creative Direction",
      description: "Strategic creative leadership from concept to execution.",
      icon: "direction"
    },
    {
      title: "3D Design",
      description: "Immersive three-dimensional visuals—from product visualizations to abstract environments that add depth and dimension to brand storytelling.",
      icon: "3d"
    },
    {
      title: "AI-Enhanced Design",
      description: "Leveraging artificial intelligence to augment creative workflows, generate unique visuals, and push the boundaries of what's possible in design.",
      icon: "ai"
    },
    {
      title: "Design Systems",
      description: "Scalable component libraries and design tokens that ensure consistency, efficiency, and future-proofing across all digital touchpoints.",
      icon: "systems"
    },
    {
      title: "Art Direction",
      description: "Conceptual vision and creative strategy that guides visual execution—ensuring every piece tells a cohesive, compelling story.",
      icon: "art"
    },
    {
      title: "Editorial Design",
      description: "Sophisticated layouts and typographic systems for publications, reports, and digital content that demand editorial excellence.",
      icon: "editorial"
    },
    {
      title: "Packaging Design",
      description: "Tangible brand experiences through thoughtful packaging—structural innovation, material selection, and visual identity in physical form.",
      icon: "packaging"
    },
    {
      title: "Arabic Calligraphy",
      description: "Artistic integration of traditional Arabic script—blending cultural heritage with contemporary design for authentic, meaningful connections.",
      icon: "calligraphy"
    },
    {
      title: "Motion Design",
      description: "Dynamic animations and interactive motion that bring brands to life—adding rhythm, emotion, and engagement to static visuals.",
      icon: "motion"
    }
  ],

  about: "Senior graphic designer with 10+ years of experience creating high-impact visual solutions for government initiatives, major events, and elite brands. Notable work includes Diriyah Gate, King Salman Gate, Riyadh Season, and collaborations with goody and Fakeeh Care Group. I blend creative direction, 3D, and AI to deliver innovative, future-ready design that elevates brands and drives results.",
  ...
  skills: {
    ...
    tools: {
      ...
      categories: [
        ...
        {
          name: "3D & Rendering",
          tools: ["Blender", "Cinema 4D", "KeyShot", "3ds Max"]
        },
        {
          name: "Presentation",
          tools: ["PowerPoint", "Keynote", "Google Slides"]
        },
        {
          name: "Audio",
          tools: ["Logic Pro"]
        ...
        {
          name: "AI & Emerging",
          tools: ["Midjourney", "Stable Diffusion", "Google AI Studio", "Claude Code", "Gemini", "ChatGPT", "Suno"]
        },
      ]
    }
  }
